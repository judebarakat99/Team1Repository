...
: ${AMENT_CURRENT_PREFIX:="/home/mscrobotics2425laptop35/leo_rover_simulation/ros2_ws/install/leo_gz_worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/leo_gz_worlds/environment/gz_sim_resource_path.sh"
