...
: ${AMENT_CURRENT_PREFIX:="/home/mscrobotics2425laptop35/leo_rover_simulation/ros2_ws/install/leo_gz_plugins"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/leo_gz_plugins/environment/gz_sim_system_plugin_path.sh"
