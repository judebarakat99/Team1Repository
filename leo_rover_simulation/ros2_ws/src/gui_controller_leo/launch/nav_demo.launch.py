...
def generate_launch_description():
    ...
    pkg_nav_demos = get_package_share_directory('gui_controller_leo')
    # Necessary fixes
    ...
    PythonLaunchDescriptionSource([get_package_share_directory('gui_controller_leo'), '/launch', '/simulation_bringup.launch.py']),
